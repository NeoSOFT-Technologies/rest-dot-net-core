...
namespace GloboTicket.TicketManagement.Mongo.Identity.UnitTests.Services
{
    public class AuthenticationServiceTests
    {
        private readonly Mock<FakeUserManager> _mockUserManager;
        private readonly Mock<FakeRoleManager> _mockRoleManager;
        ...
        public AuthenticationServiceTests()
        {
            ...
            _mockRoleManager = RoleManagerMocks.GetRoleManager();//new Mock<FakeRoleManager>();
        ...
        {
            var service = new AuthenticationService(_mockUserManager.Object, _jwtSettings, _mockSignInManager.Object, _mockRoleManager.Object);
